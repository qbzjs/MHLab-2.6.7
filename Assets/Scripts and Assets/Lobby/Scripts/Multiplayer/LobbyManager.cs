...
public class LobbyManager : MonoBehaviour {
    ...
    private async void HandleUpdateBackfillTickets() {
        if (backfillTicketId != null && payloadAllocation != null && MultiplayerManager.Instance.HasAvailablePlayerSlots()) {
            ...
            foreach (PlayerData playerData in MultiplayerManager.Instance.GetPlayerDataNetworkList()) {
